...
<?php
	...
	public function get_display( $post ) {
		...
		if ( $this->smart ) {
			return '<a href="https://teams.microsoft.com/share/" class="share-msteams sd-button teams-share-button" data-icon-px-size="16" data-href="' . get_permalink( $post->ID ) . '" >Microsoft Teams</a>';
		} else if ( $this->icon ) {
